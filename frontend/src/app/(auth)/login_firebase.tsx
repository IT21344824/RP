...
import { View, Alert, Text, TouchableOpacity, StatusBar, Image } from "react-native";
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <Animated.View entering={FadeInUp.duration(500)} className="mt-12 space-y-8">
                        ...
                        <TouchableOpacity className="bg-amber-500 py-4 rounded-lg mt-8 border-2 border-yellow-300 shadow-lg shadow-yellow-400" onPress={() => submit()} disabled={isLoading}>
