...
import Stone_Sandalwood_Grinder from "@/src/components/3dModel/Stone_Sandalwood_Grinder";
...
const Index = () => {
  ...
  console.log("Stone_Sandalwood_Grinder - index")
