...
import Stone_Vessel_Metal_Base from "@/src/components/3dModel/Stone_Vessel_Metal_Base";
import SandakadaPahana from "@/src/components/3dModel/SandakadaPahana";
