...
import Wood_Carved_Coconut_Shell from "@/src/components/3dModel/Wood_Carved_Coconut_Shell";
...
const Index = () => {
  ...
  console.log("Wood_Carved_Coconut_Shell - index")
