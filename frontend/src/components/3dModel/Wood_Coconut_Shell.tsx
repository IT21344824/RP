...
const Wood_Coconut_Shell = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Wood_Coconut_Shell.glb")
  ) as GLTFResult;
  ...
  console.log("Wood_Coconut_Shell 3D")
...
export default Wood_Coconut_Shell;
