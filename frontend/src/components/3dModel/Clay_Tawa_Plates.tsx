...
const Clay_Tawa_Plates = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Clay_Tawa_Plates.glb")
  ) as GLTFResult;
  ...
  console.log("Clay_Tawa_Plates 3D")
...
export default Clay_Tawa_Plates;
