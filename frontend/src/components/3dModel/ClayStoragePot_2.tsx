...
const ClayStoragePot_2 = (props: JSX.IntrinsicElements["group"]) => {
  ...
  useEffect(() => {
    ...
    // Ensure the material exists before modifying properties
    if (materials.model) {
      ...
      console.warn("Materials model is undefined.");
    }
  }, [materials]);
      ...
      <group scale={5} position={[0, 4.943, -12.184]} rotation={[-0.583, 0, 0]}>
        <group position={[-2.376, -1.465, 10.88]}>
          <mesh
            ...
            material={materials.model ?? new THREE.MeshStandardMaterial()}
          />
          <mesh
            castShadow
            receiveShadow
