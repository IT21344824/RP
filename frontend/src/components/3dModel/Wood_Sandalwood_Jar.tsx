...
const Wood_Sandalwood_Jar = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Wood_Sandalwood_Jar.glb")
  ) as GLTFResult;
  ...
  console.log("Wood_Sandalwood_Jar 3D")
...
export default Wood_Sandalwood_Jar;
