...
const Stone_Sandalwood_Grinder = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Stone_Sandalwood_Grinder.glb")
  ) as GLTFResult;
  ...
  console.log("Stone_Sandalwood_Grinder 3D")
...
export default Stone_Sandalwood_Grinder;
