...
const Clay_Water_Cups = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Clay_Water_Cups.glb")
  ) as GLTFResult;
  ...
  console.log("Clay_Water_Cups 3D")
...
export default Clay_Water_Cups;
