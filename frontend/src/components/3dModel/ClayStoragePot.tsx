...
const ClayStoragePot = (props: JSX.IntrinsicElements["group"]) => {
  ...
  useEffect(() => {
    ...
    // Ensure materials exist and have the correct properties
    if (materials.material_0) {
      ...
      console.warn("material_0 not found, applying default material.");
      // Fallback to a default material
      const defaultMaterial = new THREE.MeshStandardMaterial();
      defaultMaterial.metalness = 0.5;
      defaultMaterial.roughness = 0.7;
      defaultMaterial.emissive = new THREE.Color(0x000000);
      // You can set this default material wherever needed
    }
  }, [materials]);
      ...
      <group scale={2}>
        {(Object.keys(nodes) as Array<keyof typeof nodes>).map((key, index) => (
          <mesh
            ...
            material={materials.material_0 ?? new THREE.MeshStandardMaterial()} // Use fallback material here
          />
        ))}
      </group>
    </group>
