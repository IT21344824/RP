...
const Stone_Vessel_Metal_Base = (props: JSX.IntrinsicElements["group"]) => {
  const y = useSharedValue(0);
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    require("../../assets/models/Stone_Vessel_Metal_Base.glb")
  ) as GLTFResult;
...
export default Stone_Vessel_Metal_Base;
